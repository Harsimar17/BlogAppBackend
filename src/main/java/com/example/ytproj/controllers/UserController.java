...
//    @PreAuthorize("hasRole('ADMIN')")
    ...
    public HttpStatus forgotPassword(@PathVariable String uname) throws MessagingException {
        char[] charArray = uname.toCharArray();
        int i;
    ...
    @PostMapping("/checkOTP/{Otp}")
    public HttpStatus verifyOtp(@PathVariable String Otp) throws Exception {
        System.out.println("Otp  " + rcheck);
        passChange = Otp;
